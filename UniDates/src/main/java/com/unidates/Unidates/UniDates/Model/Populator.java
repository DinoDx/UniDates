...
public class Populator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        p1.addFoto(new Foto(Utils.downloadUrl("http://picsum.photos/200/300")));
        ...
        p2.addFoto(new Foto(Utils.downloadUrl("http://picsum.photos/200/300")));
        ...
        p3.addFoto(new Foto(Utils.downloadUrl("http://picsum.photos/200/300")));
        ...
        p4.addFoto(new Foto(Utils.downloadUrl("http://picsum.photos/200/300")));
        ...
        p5.addFoto(new Foto(Utils.downloadUrl("http://picsum.photos/200/300")));
