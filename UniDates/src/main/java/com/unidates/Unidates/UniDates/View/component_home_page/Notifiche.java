...
@Route(value = "notifiche", layout = MainView.class)
@PageTitle("Notifiche")
@CssImport("./styles/views/home/notifiche.css")
public class Notifiche extends Div implements AfterNavigationObserver {
    ...
    private HorizontalLayout createCard(Person person) {
        ...
        HorizontalLayout bottone = new HorizontalLayout();
        Button avviachat = new Button("Avvia chat");
        avviachat.setId("avviachat");

        bottone.add(avviachat);

        description.add(header, post);
        card.add(image, description,bottone);
        return card;
    }
