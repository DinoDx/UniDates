...
public class TestRicercaEmail extends TestBenchTestCase {
    ...
    @Test
    public void ricercaEmail_valid(){
        TextFieldElement searchField = $(TextFieldElement.class).id("ricerca-field");
        ButtonElement searchButton = $(ButtonElement.class).id("ricerca-button");
    ...
    @Test
    public void ricercaEmail_nonTrovata(){
        TextFieldElement searchField = $(TextFieldElement.class).id("ricerca-field");
        ButtonElement searchButton = $(ButtonElement.class).id("ricerca-button");

        searchField.setValue("studenteprova3@gmail.com");
        searchButton.click();

        waitUntil(ExpectedConditions.presenceOfElementLocated(By.id("errore-ricerca")));
        NotificationElement errore = $(NotificationElement.class).id("errore-ricerca");
